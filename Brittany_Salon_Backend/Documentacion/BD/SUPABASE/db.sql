...
--   1) CREATE TABLE sin FKs inline
--   2) ALTER TABLE para agregar FKs
-- Esto evita errores de pre-parseo en Supabase SQL Editor.
--
-- USO: pegar en Supabase SQL Editor y Run.
-- Si necesitas reset, ejecutalo de nuevo: los DROP limpian todo.
-- ============================================================
...
-- ============================================================
-- FASE 2: AGREGAR FOREIGN KEYS Y CONSTRAINTS
-- ============================================================
